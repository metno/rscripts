...
#  plot(Data[,1],Data[,2],type="h",lwd=6,col="#008B8B",xlab="",ylab="", main=Tittel)
  plot(Data[,1],Data[,2],type="h",lwd=6,col="#27408B",xlab="",ylab="", main=Tittel)
#  lines(c(1961,1990),c(GN,GN),lty=1,lwd=4,col="#255c36")
#  lines(c(1991,2020),c(NN,NN),lty=1,lwd=4,col="#255c36")
  lines(c(1961,1990),c(GN,GN),lty=1,lwd=4,col="#008B8B")
  lines(c(1991,2020),c(NN,NN),lty=1,lwd=4,col="#008B8B")
  print(c(GN,NN))
}
